...
class action extends app
{
	...
	private function modify()
	{
		...
		elseif($this->ev->get('modifyuserinfo'))
		{
			...
			$args = $this->module->tidyNeedFieldsPars($args,$group['groupmoduleid'],1);
		...
		else
		{
			...
			$subjects = \PHPEMS\ginkgo::make('basic','exam')->getSubjectList();
	...
	private function index()
	{
		...
		$users = $this->user->getUserList($args,$page,50);
