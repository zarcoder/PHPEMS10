		...
		<div class="pages">
			...
			<div class="content">
				<div class="content-box padding">
					<h2 class="title">
						{x2;$enbat['enbname']}
						<a href="index.php?enroll-app-enroll-detail&enrollid={x2;$enroll['enrollid']}" class="badge pull-right"> 返回 </a>
					</h2>
					<ul class="list-unstyled list-img">
						<li class="border morepadding">
							<div class="desc">
								<form action="index.php?enroll-app-enroll-modify" method="post" class="form-horizontal">
									<fieldset>
										{x2;tree:$forms,form,fid}
										<div class="form-group">
											<div class="col-xs-3 tip">
												{x2;v:form['title']}
											</div>
											<div class="col-xs-8">
												{x2;v:form['html']}
										...
										<div class="form-group">
											...
											<div class="col-xs-8">
												...
												<img src="{x2;$enroll['enrollsign']}" id="signatureimg" class="hide"/>
												<input type="hidden" name="args[enrollsign]" id="signature" value="{x2;$enroll['enrollsign']}" needle="needle" msg="请手绘签名"/>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-8">
												...
												<input type="hidden" name="enrollid" value="{x2;$enroll['enrollid']}"/>
...
<script>
	...
	ctx.drawImage($('#signatureimg')[0], 0, 0);
