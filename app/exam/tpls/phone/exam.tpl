	...
	<div class="page-tabs">
		...
		<div class="page-content header">
			<div class="list-box bg">
				<ol>
					<li><span class="rows"><span class="intro">点击考试名称进入答题界面，考试开始计时。</span></span></li>
					<li>
				...
				<ol>
					...
					<li class="unstyled">
						<a action-before="clearStorage" href="index.php?exam-phone-exam-selectquestions&examid={x2;v:exam['examid']}" class="ajax">
							<div class="rows info">
								<h5 class="title" style="color:#3498db;">{x2;v:exam['exam']}</h5>
								<div class="intro" style="color:#3498db;">
