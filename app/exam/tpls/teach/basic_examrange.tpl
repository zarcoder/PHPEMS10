...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
			        ...
			        <form action="?exam-teach-basic-setexamrange" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label class="control-label col-sm-3">正式考试人脸识别：</label>
							<div class="col-sm-9">
								<label class="radio-inline">
									<input type="radio" name="args[basicexam][faceverify]" value="1"{x2;if:$basic['basicexam']['faceverify']} checked{x2;endif}/> 开启
								</label>
								<label class="radio-inline">
									<input type="radio" name="args[basicexam][faceverify]" value="0"{x2;if:!$basic['basicexam']['faceverify']} checked{x2;endif}/> 关闭
								</label>
								<span class="help-block">开启人脸识别需要用户完成个人认证，并保证所有考试设备带有摄像头。</span>
							</div>
						</div>
						<div class="form-group">
