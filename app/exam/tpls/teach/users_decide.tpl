				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<table class="table table-hover table-bordered">
						...
						<tr>
							<td>考生答案：</td>
							<td>
								{x2;if:v:quest['questchoice'] == 102 && $sessionvars['ehuseranswer'][v:question['questionid']]}
								<a class="btn btn-primary" href="{x2;realhtml:$sessionvars['ehuseranswer'][v:question['questionid']]}">下载文件</a>
								{x2;else}
								{x2;realhtml:$sessionvars['ehuseranswer'][v:question['questionid']]}
								{x2;endif}
							</td>
						</tr>
						<tr>
