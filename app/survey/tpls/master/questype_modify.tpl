...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						修改题型
						<a class="btn btn-primary pull-right" href="index.php?{x2;$_app}-master-questype&page={x2;$page}{x2;$u}">题型管理</a>
					</h4>
			        <form action="index.php?{x2;$_app}-master-questype-modify" method="post" class="form-horizontal">
						<fieldset>
